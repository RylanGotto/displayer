...
from kanye_display.app import create_app
from kanye_display.database import db
from kanye_display.settings import DevConfig, ProdConfig
from kanye_display.user.models import User

CONFIG = ProdConfig if os.environ.get('KANYE_DISPLAY_ENV') == 'prod' else DevConfig
